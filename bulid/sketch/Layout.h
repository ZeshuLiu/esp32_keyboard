#line 1 "c:\\Users\\LiuZeshu\\Desktop\\esp32_keyboard\\v1.0.0\\poker_keyboard\\Layout.h"
#ifndef LAYOUT_H
#define LAYOUT_H
...
/*
uint8_t LayOut_words[number_out][number_in] = {
    ...
    {0,0,0,KEY_BSLASH,KEY_BACKSPACE,0,KEY_FN,0}, //2qw
    {KEY_R,KEY_4,KEY_V,KEY_F,KEY_T,KEY_5,KEY_B,KEY_G}, //344rrfvv
    {KEY_Q,KEY_1,KEY_Z,KEY_A,0,0,KEY_Z,KEY_SQUOTES}, //4II
    {KEY_E,KEY_3,KEY_C,KEY_D,KEY_E,0,KEY_C,KEY_D},//5
    {KEY_O,KEY_9,KEY_FULLSTOP,KEY_L,0,0,0,0},
    {KEY_C,KEY_7,KEY_M,KEY_J,KEY_Y,KEY_6,KEY_N,KEY_H},
};

uint8_t LayOut_commands[number_out][number_in] = {
    {KEY_I,KEY_8,KEY_COMMA,KEY_K,KEY_RBRACKET,KEY_EQUAL,0,0}, //0
    {KEY_P,KEY_0,0,KEY_SEMICOLON,KEY_LBRACKET,KEY_SUB,KEY_FSLASH,KEY_SQUOTES}, //1
...
oollddd,,,,cccccc==]]]]     ///////777ppeeaakkkkk....ee'''99ii;;\\vvvvv[[]]''8833ffm--66666666ttggdd11100rrrrrrjjjyyyhhh
